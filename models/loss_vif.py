...
class fusion_loss_vif(nn.Module):
    def __init__(self):
        ...
        # print(1)
    def forward(self, image_A, image_B, image_fused):
        loss_l1 = self.L_Inten(image_A, image_B, image_fused)  # 原来的权重为20
        loss_gradient = self.L_Grad(image_A, image_B, image_fused)  # 原来的权重为20
        loss_SSIM = (1 - self.L_SSIM(image_A, image_B, image_fused))  # 原来的权重为10
